...
public class ProductResultPage extends BasePage {
    ...
    private By results = new By.ByCssSelector("section.content div.goods-tile");
    private By titlePath = new By.ByCssSelector("span.goods-tile__title");
    private By sellerRozetkaCheckbox = new By.ByXPath("//div[@data-filter-name='seller']//input[@id='Rozetka']/parent::a");
    private By sellerRUOtherCheckbox = new By.ByXPath("//input[@id='Другие продавцы']");
    private By sellerUAOtherCheckbox = new By.ByXPath("//input[@id='Інші продавці']");
